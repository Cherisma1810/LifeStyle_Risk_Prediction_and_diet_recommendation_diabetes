...
**Download it from:** [Kaggle — PIMA Indians Diabetes Dataset](https://www.kaggle.com/datasets/uciml/pima-indians-diabetes-database)
...
|---|---|
| 🔴 **Strict** | High risk — significant dietary and lifestyle changes needed |
| 🟡 **Moderate** | Moderate risk — improve habits and monitor progress |
| 🟢 **Maintain** | Low risk — keep up the good work |
...
Grab `diabetes.csv` from [Kaggle](https://www.kaggle.com/datasets/uciml/pima-indians-diabetes-database) and place it in the project folder alongside `diabetes.py`.
